...
def main():
	...
	player = Player()
	walls = [
		Surface(Vector(0, 800), 1920, 580, .95, "#000000"),
		Surface(Vector(0, 0), 10, 1080, .95, "#000000"),
		Surface(Vector(1910, 0), 10, 1080, .95, "#000000"),
		Surface(Vector(180, 780), 80, 20, .95, "#000000"),
		Surface(Vector(295, 700), 80, 20, .95, "#000000"),
		Surface(Vector(410, 670), 80, 20, .95, "#000000"),
		Surface(Vector(510, 640), 80, 20, .95, "#000000"),
		Surface(Vector(620, 610), 80, 20, .95, "#000000"),
		Surface(Vector(730, 520), 80, 20, .95, "#000000"),
		Surface(Vector(840, 470), 80, 20, .8, "#000000"),
		Surface(Vector(1150, 570), 60, 20, .95, "#000000"),
		Surface(Vector(1200, 560), 10, 10, .95, "#000000"),
		Surface(Vector(1240, 600), 60, 20, .95, "#000000"),
		Surface(Vector(1340, 560), 60, 20, .95, "#000000"),
		Surface(Vector(1440, 460), 60, 20, .95, "#000000"),
		...
		Surface(Vector(1275, 200), 50, 20, .95, "#000000"),
