...
def load_level(level: int) -> list[Surface]:
	if level == 1:
		return [
			# Surface(Vector(,), , , ),
			Surface(Vector(0, 800), 1920, 580, -.1),
			Surface(Vector(180, 780), 80, 20, -.1),
			Surface(Vector(290, 700), 80, 20, -.1),
			Surface(Vector(410, 670), 80, 20, -.1),
			Surface(Vector(510, 640), 80, 20, -.1),
			Surface(Vector(620, 610), 80, 20, -.1),
			Surface(Vector(730, 520), 80, 20, -.1),
			Surface(Vector(840, 470), 80, 20, -.1),
			Surface(Vector(1145, 570), 65, 20, -.15),
			Surface(Vector(1220, 480), 10, 40, -.15),
			Surface(Vector(1240, 600), 60, 20, -.15),
			Surface(Vector(1340, 560), 60, 20, -.15),
			Surface(Vector(1450, 410), 60, 20, -.1),
			Surface(Vector(1450, 290), 100, 20, -.1),
			Surface(Vector(1700, 290), 60, 20, -.1),
			Surface(Vector(1800, 190), 10, 60, -.1),
			Surface(Vector(1700, 190), 100, 20, -.1),
			Surface(Vector(1700, 100), 10, 90, -.1),
			Surface(Vector(1845, 290), 20, 20, -.1),
			Surface(Vector(1815, 300), 30, 10, -.3),
			Surface(Vector(1800, 110), 20, 100, -.1),
			Surface(Vector(1400, 110), 200, 20, -.1),
			Surface(Vector(1500, 20), 10, 63, -.1),
			Surface(Vector(1400, 0), 520, 20, -.1),
			Surface(Vector(600, 0), 120, 20, -.3),
			Surface(Vector(400, 0), 100, 20, -.1),
			Surface(Vector(150, 0), 150, 20, -.1),
			Surface(Vector(100, -100), 100, 20, -.1),
			Surface(Vector(180, -300), 20, 200, -.1),
			Surface(Vector(0, -200), 50, 20, -.1),
			Surface(Vector(0, -400), 200, 20, -.1),
			Surface(Vector(0, -600), 200, 200, -.1),
			...
			Surface(Vector(1650, -830), 20, 20, -.1),
			Surface(Vector(1430, -930), 50, 20, -.1),
			Surface(Vector(1400, -950), 30, 40, -.1),
			# Surface(Vector(1005, 175), 90, 20, -.1),
			# Surface(Vector(0, 0), 700, 40, -.1),
			# Surface(Vector(800, 0), 1120, 40, -.1),
			# Surface(Vector(840, 150), 70, 20, -.1),
			# Surface(Vector(800, 0), 100, 75, -.1),
			# Surface(Vector(720, 150), 30, 20, -.1),
			# end of first section (no slid jumps yet)
			# Surface(Vector(680, -500), 20, 400, -.1),
			# Surface(Vector(680, -40), 20, 40, -.1),
			Surface(Vector(0, -2000), 10, 3080, -.1),
			Surface(Vector(1910, -2000), 10, 3080, -.1),
		]
	else:
		return []
